...
export class T2IAdapterParameter extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: T2IAdapterParameter
  ): T2IAdapterParameter.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
...
export class ContentCredentialsParameters extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: ContentCredentialsParameters
...
export class FineTuningParameters extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: FineTuningParameters
  ): FineTuningParameters.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
...
export class ImageParameters extends jspb.Message {
  ...
  addFineTuningParameters(
    value?: FineTuningParameters,
    index?: number
  ): FineTuningParameters;
...
export class ArtifactTypeFilter extends jspb.Message {
  ...
  addInclude(
    value: ArtifactTypeMap[keyof ArtifactTypeMap],
    index?: number
  ): ArtifactTypeMap[keyof ArtifactTypeMap];
  ...
  static toObject(
    includeInstance: boolean,
    msg: ArtifactTypeFilter
  ): ArtifactTypeFilter.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
